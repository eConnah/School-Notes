A scale for numbers, where each step represents a power of 10. Orders of magnitude tell you which step a number falls on, giving you a rough idea of its size without the burden of exact digits.
