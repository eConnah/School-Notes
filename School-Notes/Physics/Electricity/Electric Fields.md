Electric field strength is defined as the electric force per unit positive test charge. It is a vector quantity with the units $\mathrm{NC}^{-1}$ or $\mathrm{Vm}^{-1}$.
$$E = \frac{V}{d}$$
$$E=\frac{F}{Q}$$
$$\frac{Q}{m}=\frac{ad}{V}$$
